/**
 * Glitter.kr Basic Comm User Template
 *
...
const logger = ((window as any).G7Core?.createLogger?.('Template:sirsoft-basic_comm')) ?? {
    log: (...args: unknown[]) => console.log('[Template:sirsoft-basic_comm]', ...args),
    warn: (...args: unknown[]) => console.warn('[Template:sirsoft-basic_comm]', ...args),
    error: (...args: unknown[]) => console.error('[Template:sirsoft-basic_comm]', ...args),
};
